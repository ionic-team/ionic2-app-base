...
The `ionic serve` command compiles your ES6 files to ES5, your SASS files to CSS, and then bundles it all up for you.  The build output can be configured in your `ionic.config.js` file (which will be autogenerated by `ionic serve` if it doesn't exist yet).
